...
public interface GlobalconfigRepository extends JpaRepository<Globalconfig, Long> {
	...
	List<Globalconfig> findByRecursiveByEnvAndRecursiveBySubEnvAndRecursiveByRel(boolean recursiveByEnv, boolean recursiveBySubEnv, boolean recursiveByRelease);
