...
public class SubEnvironmentConfigDTOService {
    ...
    public List<SubEnvironmentConfigDTO> findByTypeAndEnvironmentName(String typeName, String envName) {
        List<SubEnvironmentConfig> results = subEnvironmentConfigRepository.findBySubEnvironment_subEnvironmentType_nameAndSubEnvironment_environment_name(typeName, envName);
